package com.myhomepage.homepage.config;
...
public class DataSourceConfig {
	...
	@Bean
	@ConfigurationProperties(prefix="security.datasource") // This could also be app.datasource, as the user and movie database uses the same datasource.
